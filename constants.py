...
TOOLS = ['dutch oven', 'pot', 'pan', 'baking dish', 'skillet', 'sheet', 'dish', 'oven', 'rice cooker', 'pressure cooker'
    'grater', 'whisk', 'spoon', 'fork', 'tongs', 'spatula', 'peeler', 'thermometer', 'funnel',
